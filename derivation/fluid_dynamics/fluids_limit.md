...
Implementation plan
- Module: [lbm2d.py](../code/physics/fluid_dynamics/fluids/lbm2d.py
...
- New module: [lbm2d.py](../code/physics/fluid_dynamics/fluids/lbm2d.py (D2Q9 BGK).
- Benchmarks using shared logging/figure style:
  - Taylor€“Green vortex: [taylor_green_benchmark.py](../code/physics/fluid_dynamics/taylor_green_benchmark.py
  - Lid€‘driven cavity: [lid_cavity_benchmark.py](../code/physics/fluid_dynamics/lid_cavity_benchmark.py
- Acceptance thresholds: see [BENCHMARKS_FLUIDS.md](../../BENCHMARKS_FLUIDS.md.
...
Details in [BENCHMARKS_FLUIDS.md](../../BENCHMARKS_FLUIDS.md.
...
- RD Fisher€“KPP front speed (canonical RD check) remains unchanged; see:
  - Validation: [rd_front_speed_validation.md](reaction_diffusion/rd_front_speed_validation.md
  - Experiment: [rd_front_speed_experiment.py](code/physics/rd_front_speed_experiment.py
...
- Module: [lbm2d.py](../code/physics/fluid_dynamics/fluids/lbm2d.py (D2Q9 BGK).
- Benchmarks:
  - [taylor_green_benchmark.py](../code/physics/fluid_dynamics/taylor_green_benchmark.py
  - [lid_cavity_benchmark.py](../code/physics/fluid_dynamics/lid_cavity_benchmark.py
- Acceptance: [BENCHMARKS_FLUIDS.md](../../BENCHMARKS_FLUIDS.md
- Outputs:
