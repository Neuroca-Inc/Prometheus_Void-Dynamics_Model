...
Validation Plan
- Script: ../../code/physics/memory_steering/memory_steering_acceptance.py
  - Experiments:
  ...
  - Outputs:
    - JSON: ../../code/outputs/logs/memory_steering/memory_steering_acceptance_YYYYMMDDThhmmssZ.json
    - Figures (PNG): ../../code/outputs/figures/memory_steering/
...
- Activate venv and run:
  ...
  python -m derivation.code.physics.memory_steering.memory_steering_acceptance --seed 0 --steps 512 --g 0.12 --lam 0.08
