...
New Artifacts
- Doc: ../derivation/memory_steering/memory_steering_acceptance_verification.md
- Script: ../derivation/code/physics/memory_steering/memory_steering_acceptance.py
- Tests: ../derivation/code/tests/physics/test_memory_steering.py
- Output locations (when run):
  - JSON logs → ../derivation/code/outputs/logs/memory_steering/
  - Figures → ../derivation/code/outputs/figures/memory_steering/
